 ...
 *     documents_dir?: scalar|Param|null, // Dossier où seront stockés les documents (PDF, DOC, XLS, CSV, etc.) // Default: "%kernel.project_dir%/public/uploads/documents"
 *     videos_dir?: scalar|Param|null, // Dossier où seront stockées les vidéos (MP4, AVI, MOV, etc.) // Default: "%kernel.project_dir%/public/uploads/videos"
 *     images_dir?: scalar|Param|null, // Dossier où seront stockées les images (JPG, PNG, GIF, etc.) // Default: "%kernel.project_dir%/public/uploads/images"
 * }
